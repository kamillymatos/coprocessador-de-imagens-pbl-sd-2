...
#define PIO_INSTRUCT_SPAN 32
#define PIO_INSTRUCT_END 0x1f
#define PIO_INSTRUCT_BIT_CLEARING_EDGE_REGISTER 0
#define PIO_INSTRUCT_BIT_MODIFYING_OUTPUT_REGISTER 1
#define PIO_INSTRUCT_CAPTURE 0
#define PIO_INSTRUCT_DATA_WIDTH 32
...
/*
 * Macros for device 'pio_start', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_START_'.
 * The prefix is the slave descriptor.
 */
#define PIO_START_COMPONENT_TYPE altera_avalon_pio
#define PIO_START_COMPONENT_NAME pio_start
#define PIO_START_BASE 0x30
#define PIO_START_SPAN 16
#define PIO_START_END 0x3f
...
#define SYSID_QSYS_TIMESTAMP 1762022696
